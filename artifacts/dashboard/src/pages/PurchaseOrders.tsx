...
<style>
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  .auth-grid{display:grid;grid-template-columns:1fr 1fr;gap:32px;margin-top:28px}
  .auth-block .auth-line{border-bottom:1px solid #999;margin-bottom:4px;height:28px}
  .auth-block .auth-lbl{font-size:8.5px;font-weight:700;text-transform:uppercase;letter-spacing:0.8px;color:#aaa}
  .notes-box{margin-top:14px;padding-top:10px;border-top:1px solid #e8e8e8;margin-bottom:20px}
