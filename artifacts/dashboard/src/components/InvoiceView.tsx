...
<style>
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  .s-overdue{color:#b91c1c}
  .s-draft{color:#999;border-color:#ccc}
  .s-cancelled{color:#aaa;border-color:#ccc}
  ...
  .isku{display:inline-block;font-size:10px;font-family:'Courier New',monospace;color:#aaa;background:#f5f5f5;padding:1px 4px}
  ...
  .info-box{margin-top:14px;padding-top:10px;border-top:1px solid #e8e8e8}
  .info-box-lbl{font-size:8.5px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#aaa;margin-bottom:5px}
  .pay-box .info-box-lbl{color:#166534}
  .pay-box p{font-size:12px;color:#166534;line-height:1.65}
  .notes-box .info-box-lbl{color:#888}
